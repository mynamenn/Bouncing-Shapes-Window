...
public class Oval extends ClosedShape {
     ...
     * @param isFlashing True if the oval is flashing.
     * @param colour2 The second line colour or fill colour.
     */
    public Oval(int insertionTime, int x, int y, int vx, int vy, int width, int height, Color colour, boolean isFilled, boolean isFlashing, Color colour2) {
