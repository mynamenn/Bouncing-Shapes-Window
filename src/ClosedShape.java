 ...
 * the purposes of CSC-115 (Daniel Archambault and Liam O'Reilly)
 */
...
public abstract class ClosedShape {
    ...
    /**
     * Determines if the Shape is flashing or not.
     */
    protected boolean isFlashing;

    /**
     * The second line colour of the shape, or the filled in colour if the Shape
     * has fill.
     */
    protected Color colour2;

    /**
     * Temp saves a copy of colour.
     */
     ...
     */
    protected ClosedShape(int insertionTime, int x, int y, int vx, int vy,
            Color colour, boolean isFilled, boolean isFlashing, Color color2) {
        this.x = x;
        this.y = y;
        this.xVec = vx;
        this.yVec = vy;
